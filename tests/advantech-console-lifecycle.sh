...
grep -Fxq 'ZBMC_QEMU=/home/zen/opt/qemu-11/bin/qemu-system-arm' "$repo/boxes/advantech-asmb787/zbmc.box"
grep -Fxq 'ZBMC_QEMU_MAJOR=11' "$repo/boxes/advantech-asmb787/zbmc.box"
