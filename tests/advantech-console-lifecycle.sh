...
grep -Fxq 'ZBMC_REQUIRED_SERVICES="console ipmi redfish"' "$repo/boxes/advantech-asmb787/zbmc.box"
...
grep -Fq 'direct-L2 TAP, serial console, and IPMI verified' "$repo/boxes/advantech-asmb787/zbmc.box"
grep -Fq 'guest-owned TAP address, serial console, and authenticated IPMI verified' "$repo/boxes/advantech-asmb787/zbmc.box"
