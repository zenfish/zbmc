...
grep -Fq 'xcc_fpga_supported_blocks[16]' "$repo/qemu/patches/lenovo-xcc-fpga-emmc-gp0.patch"
grep -Fq '0x05, 0x09' "$repo/qemu/patches/lenovo-xcc-fpga-emmc-gp0.patch"
