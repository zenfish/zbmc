...
# deps (Debian): sudo apt install qemu-system-arm squashfs-tools u-boot-tools device-tree-compiler curl sshpass socat python3-pexpect python3-pip && pip3 install jefferson
