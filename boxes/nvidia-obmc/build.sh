...
echo
echo "next:  ./tools/zbmc nvidia-obmc start"
echo "       ./tools/zbmc nvidia-obmc ssh 'uname -a'          # root / 0penBmc"
echo "       ./tools/zbmc nvidia-obmc ipmi mc info            # + OEM NetFn 0x3C handlers"
