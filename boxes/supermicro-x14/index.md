...
Extract the boot initramfs separately:

    mkdir -p work/supermicro-x14/fs/initramfs
    xz -dc work/supermicro-x14/initramfs-patched.bin | (cd work/supermicro-x14/fs/initramfs && cpio -idm --no-absolute-filenames)
