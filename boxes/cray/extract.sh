...
#        them in the scratch workdir so boot-cray.sh / boot-cray-svc.sh can run them.
...
# RELATED: boot-cray.sh (shell), boot-cray-svc.sh (real init + net), vbmc.box, README.html.
set -euo pipefail
...
# cmdline (see boot-cray-svc.sh) MUST match this layout: conf @1M, bkupconf @3M.
python3 - <<PY
sz=64*1024*1024
