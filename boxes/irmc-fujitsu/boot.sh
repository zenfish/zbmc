...
nohup "$QEMU_BIN" \
  ...
  -append 'console=ttyS4,115200n8 earlycon=uart8250,mmio32,0x1e784000,115200n8 imagebooted=1 nosmp irqchip.gicv2_force_probe=1 loglevel=7 hung_task_panic=0 hung_task_timeout_secs=0 irmc_no_redfish irmc_diag_shell irmc_diag_root irmc_diag_ipmi' \
